...
# File paths
input_file = '/home/kravt/QE/qe-7.4.1/BP/Bulk/D = 0/bulk_bp.bands.out'
output_file = '/home/kravt/QE/qe-7.4.1/BP/Bulk/D = 0/bulk_bp_bands_coulumb_data.txt'
...
with open(input_file, 'r', encoding='utf-8') as f:
    ...
    while i < len(content):
        ...
        if k_match:
            ...
            while i < len(content) and len(current_energies) < n_bands:
